...
@negative
Scenario: Login user with valid username, valid password, remember me selected, account is enabled, account is expired, account not locked
...
@negative
Scenario: Login user with valid username, valid password, remember me selected, account is enabled, account not expired, account not locked, credentials expired
...
@negative
Scenario: Login user with valid username, valid password, remember me selected, account is enabled, account is locked
...
@negative
Scenario: Login user with valid username, valid password, remember me selected, account is disabled
...
@negative
Scenario: Login user with valid username, valid password, remember me not selected, account is enabled, account is expired, account not locked
  Given Emerson is a registered user
  And he or she has an expired account
  When Emerson navigates to the Login page
  And he or she enters 'expired@demo.io' into the login Username field
...
@negative
Scenario: Login user with valid username, valid password, remember me not selected, account is enabled, account not expired, account not locked, credentials expired
  Given Eddie is a registered user
  And he or she has an account with expired credentials
  When Eddie navigates to the Login page
  And he or she enters 'expiredPassword@demo.io' into the login Username field
...
@negative
Scenario: Login user with valid username, valid password, remember me not selected, account is enabled, account is locked
  Given Everson is a registered user
  And he or she has a locked account
  When Everson navigates to the Login page
  And he or she enters 'locked@demo.io' into the login Username field
...
@negative
Scenario: Login user with valid username, valid password, remember me not selected, account is disabled
  Given Emmit is a registered user
  And he or she has a disabled account
  When Emmit navigates to the Login page
  And he or she enters 'disabled@demo.io' into the login Username field
...
Scenario: Login user with valid username, invalid password
  ...
  When Josh navigates to the Login page
  And he or she enters 'jsmith@demo.io' into the login Username field
  And he or she enters 'qbwRnTCk32' into the login Password field
  And he or she submits the login request
...
Scenario: Login user with invalid username, valid password
  Given Josh is a registered user
  When Josh navigates to the Login page
  And he or she enters 'RZ7725TxzAZfTl5@demo.io' into the login Username field
  And he or she enters 'Demo123!' into the login Password field
  And he or she submits the login request
  Then Josh verifies he or she is presented with a error message indicating invalid credentials or access denied
...
Scenario: Login user with invalid username, invalid password
  Given Josh is a registered user
  When Josh navigates to the Login page
  And he or she enters 'Tpb33gKXWR@demo.io' into the login Username field
  And he or she enters 'GzAlXHMYXMk35584' into the login Password field
  And he or she submits the login request
  Then Josh verifies he or she is presented with a error message indicating invalid credentials or access denied
...
Scenario: Login user with empty username, invalid password
  ...
  When Josh navigates to the Login page
  And he or she enters '' into the login Username field
  And he or she enters 'uCBqFjGRAWuJ74' into the login Password field
  And he or she submits the login request
  Then Josh verifies he or she is presented with a error message indicating invalid credentials or access denied